...
class Element_Nav_Menu extends Element {
	...
	public function set_controls() {
		...
		if ( bricks_is_builder() ) {
			$menus = apply_filters( 'bricks/elements/nav_menu/menus', null );
			$menus = is_array( $menus ) ? $menus : wp_get_nav_menus();

			foreach ( $menus as $menu ) {
				$nav_menus[ $menu->term_id ] = apply_filters( 'bricks/elements/nav_menu/name', $menu->name, $menu );
			}
		}
