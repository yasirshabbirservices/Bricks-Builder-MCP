...
class Tools_Registry {
	...
	private function get_tool_group_map(): array {
		return [
			...
			// surecart
			'surecart_list_products'        => 'surecart',
			'surecart_get_product'          => 'surecart',
			'surecart_list_collections'     => 'surecart',
			'surecart_get_collection'       => 'surecart',
			'surecart_list_forms'           => 'surecart',
			'surecart_get_dynamic_tags'     => 'surecart',
			'surecart_get_bricks_elements'  => 'surecart',
			'surecart_get_template_guide'   => 'surecart',
		];
	}
